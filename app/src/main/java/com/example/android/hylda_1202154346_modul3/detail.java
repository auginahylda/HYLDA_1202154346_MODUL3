...
public class detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Detail Mineral");

        //mengakses gambar, nama, detail, ukuran maupun battery yang ada pada layout
        ...
        //setting gambar dengan gambar yang di dapat intent
        gambar.setImageDrawable(this.getResources().getDrawable(Integer.valueOf(getIntent().getStringExtra("gambar"))));
        //setting nama pada layout dengan nama yang di dapat intent
        nama.setText(getIntent().getStringExtra("name"));
        //setting detail dengan deskripsi yang di dapat dari intent
        detail.setText(getIntent().getStringExtra("detail"));
        //setting battery pada level terendah
