...
/**
 * Created by Nonoy on 25/02/2018.
 */
...
public class adapter extends RecyclerView.Adapter<adapter.holdermn> {
    ...
    public adapter(Context context, List<list> menu) {
    ...
    public holdermn onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru
        View vw = LayoutInflater.from(context).inflate(R.layout.card, parent, false);
        ...
        public holdermn(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent move = new Intent(context, detail.class);
